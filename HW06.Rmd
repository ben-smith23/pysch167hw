...
Use one of the color palettes you created. Create a *named vector* containing both the factor level colors and their corresponding colors in some way you see fit and use that vector to assign those colors  *manually* to the levels in your plot.  
